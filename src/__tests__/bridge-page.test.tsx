...
// stay predictable.
const mockWallet = {
  address: 'GAIUIQ7G3TMN53Z2Y3Y5CJI7Q7ZQJX4W5F5N5Z5Q5Z5Q5Z5Q5Z5Q5Z5A',
  publicKey: 'GAIUIQ7G3TMN53Z2Y3Y5CJI7Q7ZQJX4W5F5N5Z5Q5Z5Q5Z5Q5Z5Q5Z5A',
...
vi.mock('@/lib/stellar', async () => {
  const actual =
    await vi.importActual<typeof import('@/lib/stellar')>('@/lib/stellar');
  return {
    ...actual,
