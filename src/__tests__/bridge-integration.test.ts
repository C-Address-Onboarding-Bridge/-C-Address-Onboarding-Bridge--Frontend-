...
const G_ADDRESS = 'GAIUIQ7G3TMN53Z2Y3Y5CJI7Q7ZQJX4W5F5N5Z5Q5Z5Q5Z5Q5Z5Q5Z5';
const C_ADDRESS = 'CAIUIQ7G3TMN53Z2Y3Y5CJI7Q7ZQJX4W5F5N5Z5Q5Z5Q5Z5Q5Z5Q5Z5';
const MOCK_TX_HASH =
...
describe('loadAccountInfo', () => {
  ...
  it('throws on non-404 errors', async () => {
    ...
    await expect(loadAccountInfo(G_ADDRESS, 'TESTNET')).rejects.toThrow(
      'Network error'
    );
  });
});
